...
<ul>
    ...
    <div id="AdminContent">
<div class="MainForm">
<form id="BlogForm" action="blog/edit_update/<?php echo $blog->BLOG_ID?>" method="POST">
<input id="hdn_blog_id" name="draft" value="0" type="hidden">
  ...
  <tr>
	...
	<select name="catalog">
	  ...
	  <option selected="selected" value="1">工作日志</option>
	)
	  <option value="2">日常记录</option>
	)
	  <option value="3">转贴的文章</option>
		</select>
