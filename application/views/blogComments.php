...
<div class="MainForm BlogCommentManage">
  <h3>共有 <?php echo count($com)?> 篇博客评论，每页显示 20 个，共 1 页</h3>
  <ul>
      <?php foreach($mycom as $value){?>
		...
		<span class="comment">
		<div class="user"><b><?php echo $value->USER_NAME?></b> 评论了 <a href="viewPost_comment.htm" target="_blank"><?php echo $value->TITLE?></a></div>
		<div class="content"><p><?php echo $value->CONTENT?></p></div>
		<div class="opts">
			<span style="float:right;">
			<a href="javascript:delete_c_by_id(24027,154693,261665734)">删除</a> |
			<a href="javascript:delete_c_by_user(154693)">删除此人所有评论</a>
			</span>			
			<?php echo $value->CMT_TIME?>
		</div>
		</span>
		<div class="clear"></div>
            <?php }?>
