...
<div id="OSC_Banner">
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
				Johnny [ <a href="blog/unlogin">退出</a> ]
...
<div id="AdminScreen">
	...
	<li class="caption">个人信息管理		
		<ol>
			<li><a href="message/leavemessage">站内留言(0/1)</a></li>
...
<ul>
	<li class="caption">博客管理	
		<ol>
			...
			<li class="current"><a href="blog/blogCatalogs">博客设置/分类管理</a></li>
			<li><a href="blog/issue">文章管理</a></li>
			<li><a href="comment/blogComments">博客评论管理</a></li>
		</ol>
	</li>
</ul>
</div>
...
<form class="BlogCatalogs" action="catalog/addBlogCatalog">
...
<table cellpadding="1" cellspacing="1">
	...
	<tr id="catalog_92334">
		<td class="idx"><?php echo $value->SORT_ORDER?></td>
		<td class="name"><a href="editCatalog.htm" title="点击修改博客分类"><?php echo $value->NAME?></a></td>
